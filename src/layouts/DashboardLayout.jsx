    ...
    <div style={{ position: "fixed", inset: 0, display: "flex", flexDirection: "column", background: "#f6f7fb", overflow: "hidden" }}>
      ...
      <header className="h-shell">
        <div className="crest-abs">
          ...
          >
            {showLogo ? (
              <img src={logoSrc} alt={`${orgName} logo`} onError={() => setShowLogo(false)} />
            ) : (
        ...
        <div className="brand">
          <div className="title" title={displayName}>
            {displayName}
          </div>
          ...
          <div className="pill-org" title="Account number">
            ...
            <span style={{ opacity: 0.9, fontSize: 12 }}>Account Number:</span>
            <strong style={{ fontSize: 12 }}>{accountNumber}</strong>
            <button className="copy" onClick={() => navigator.clipboard.writeText(accountNumber)}>
              Copy
            </button>
          </div>
        </div>
        ...
        <div className="nav-actions">
          ...
          <Link to="/builder-dashboard" className="link">
            Main Menu
          </Link>
          ...
          <button title="Notifications" className="link" style={{ display: "inline-flex", alignItems: "center" }}>
            🔔
          </button>
          <button title="Profile" className="link" style={{ display: "inline-flex", alignItems: "center" }}>
            👤
          </button>
        </div>
      </header>
      ...
      >
        {/* ✅ allow main outlet area to scroll */}
        <main style={{ minHeight: 0, overflowY: "auto", overflowX: "hidden" }}>
          <Outlet />
        </main>
